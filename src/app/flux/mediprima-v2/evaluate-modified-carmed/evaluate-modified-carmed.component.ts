...
@Component({
  selector: 'app-evaluate-modified-carmed',
  templateUrl: './evaluate-modified-carmed.component.html',
  providers: [
...
export class EvaluateModifiedCarmedComponent implements OnInit {
