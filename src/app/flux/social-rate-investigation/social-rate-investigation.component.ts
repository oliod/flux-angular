...
@Component({
  selector: 'app-social-rate-investigation',
  templateUrl: './social-rate-investigation.component.html',
  providers: []
})
export class SocialRateInvestigationComponent implements OnInit {

  private address = 'social_rate_investigation/consulter/';
  public hint: boolean;
