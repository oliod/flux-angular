...
@Component({
  selector: 'app-lw-periods-per-pcsa-flanders',
  templateUrl: './lw-periods-per-pcsa-flanders.component.html',
  providers: [
...
export class LWPeriodsPerPCSAFlandersComponent implements OnInit {

  private address = 'living_wages/consulter/getLivingWagePeriodsPerPCSAFlanders/';
