...
@Component({
  selector: 'app-lw-periods',
  templateUrl: './lw-periods.component.html',
  providers: [
...
export class LWPeriodsComponent implements OnInit {

  private address = 'living_wages/consulter/getLivingWagePeriods/';
