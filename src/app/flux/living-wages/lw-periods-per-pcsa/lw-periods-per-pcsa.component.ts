...
@Component({
  selector: 'app-lw-periods-per-pcsa',
  templateUrl: './lw-periods-per-pcsa.component.html',
  providers: [
...
export class LWPeriodsPerPCSAComponent implements OnInit {

  private address = 'living_wages/consulter/getLivingWagePeriodsPerPCSA/';
