...
@Component({
  selector: 'app-lw-periods-flanders',
  templateUrl: './lw-periods-flanders.component.html',
  providers: [
...
export class LWPeriodsFlandersComponent implements OnInit {

  private address = 'living_wages/consulter/getLivingWagePeriodsFlanders/';
