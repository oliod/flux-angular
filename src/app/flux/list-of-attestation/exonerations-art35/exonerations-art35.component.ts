...
@Component({
  selector: 'app-exonerations-art35',
  templateUrl: './exonerations-art35.component.html',
  providers: [
...
export class ExonerationsArt35Component implements OnInit {

  private address = 'list_of_attestation/exonerations_art35/';
