...
@Component({
  selector: 'app-prime-installation',
  templateUrl: './prime-installation.component.html',
  providers: [
...
export class PrimeInstallationComponent implements OnInit {

  private address = 'list_of_attestation/prime_installation/consulter/';
