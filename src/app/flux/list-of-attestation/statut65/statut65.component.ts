...
@Component({
  selector: 'app-statut65',
  templateUrl: './statut65.component.html',
  providers: [
...
export class Statut65Component implements OnInit {

  private address = 'list_of_attestation/statut65/consulter/';
