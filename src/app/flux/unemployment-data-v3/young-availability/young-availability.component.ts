...
@Component({
  selector: 'app-young-availability',
  templateUrl: './young-availability.component.html',
  providers: [
...
export class YoungAvailabilityComponent implements OnInit {

  private address = 'unemployment_data/neo/consulter/consultYoungAvailabilityDecisionHistory/';
