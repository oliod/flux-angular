...
@Component({
  selector: 'app-activation-paid-sums',
  templateUrl: './activation-paid-sums.component.html',
  providers: [
...
export class ActivationPaidSumsComponent implements OnInit {

  private address = 'unemployment_data/neo/consulter/consultActivationPaidSums/';
  ...
  public getValueFromInput(name: string): string {
    ...
    const allAllowance = ( (this.form.get('allAllowance').value) ? 1 : 0);
