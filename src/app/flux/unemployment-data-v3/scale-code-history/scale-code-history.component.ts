...
@Component({
  selector: 'app-scale-code-history',
  templateUrl: './scale-code-history.component.html',
  providers: [
...
export class ScaleCodeHistoryComponent implements OnInit {

  private address = 'unemployment_data/neo/consulter/consultScaleCodeHistory/';
