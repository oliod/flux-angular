...
@Component({
  selector: 'app-sanction-history',
  templateUrl: './sanction-history.component.html',
  providers: [
...
export class SanctionHistoryComponent implements OnInit {

  private address = 'unemployment_data/neo/consulter/consultSanctionHistory/';
