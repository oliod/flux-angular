...
@Component({
  selector: 'app-immovable-properties',
  templateUrl: './immovable-properties.component.html',
  providers: [
...
export class ImmovablePropertiesComponent implements OnInit {
  ...
  private address = 'patrimony_service/consulter/immovable_properties/';
